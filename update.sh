...
do
	case $opt in
		"Update bot")
			...
			sleep 3
			git clone https://github.com/0fariid0/wizwizxui-timebot.git /var/www/html/wizwizxui-timebot
		...
		"Update panel")
			...
			echo "Folder created successfully!"
			 ...
			 cd /var/www/html/
			 wget -O wizwizpanel.zip https://github.com/0fariid0/wizwizxui-timebot/releases/download/10.2.1/wizwizpanel.zip
		...
		"Backup")
			...
			wget https://raw.githubusercontent.com/0fariid0/wizwizxui-timebot/main/dbbackupwizwiz.sh | chmod +x dbbackupwizwiz.sh
			./dbbackupwizwiz.sh
